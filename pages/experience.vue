<template>
  <main class="p-8 col-span-full">
    <section id="work" class="items-start grid-cols-3 gap-8 md:grid">
      <section class="items-start grid-cols-3 col-span-3 gap-8 mb-8 md:grid">
        <div class="mb-4">
          <h3 class="items-center text-xl font-semibold">Chief Product Officer</h3>
          <div class="text-gray-500">October 2020 – Today</div>
          <p class="text-gray-500">be+</p>
        </div>
        <div class="col-span-2">
          <h4 class="sr-only">Achievements</h4>
          <div class="p-4 space-y-2 text-sm font-medium bg-contrast">
            <p class="flex items-start gap-2">
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                class="inline-block w-5 opacity-50 shrink-0"
              >
                <path
          ...
          <ul role="list" class="p-4 space-y-2 text-sm leading-6 opacity-70">
            <li class="flex gap-x-3">
              <svg
                ...
                fill="currentColor"
                aria-hidden="true"
                class="flex-none w-5 h-6 opacity-50"
              >
                <path
                  fill-rule="evenodd"
      ...
      <section class="items-start grid-cols-3 col-span-3 gap-8 mx-auto mb-8 md:grid">
        <div class="mb-4">
          <h3 class="items-center text-xl font-semibold">Lead Designer &amp; Senior Project Manager</h3>
          <div class="text-gray-500">May 2018 - September 2020</div>
          <p class="text-gray-500">adorsys</p>
        </div>
        <div class="col-span-2">
          <h4 class="sr-only">Achievements</h4>
          <div class="p-4 space-y-2 text-sm font-medium bg-contrast">
            ...
            <p class="flex items-start gap-2">
              ...
              Responsible for (7-figure) project budgets and forecasts in large-scale, complex projects with over 100
              team members.
            </p>
            <p class="flex items-start gap-2">
              <svg
              ...
              Definition of project scopes and strategic support for customers in the creation of product roadmaps.
              Ensuring that budgets and customer requirements are met.
            </p>
          </div>
          <h4 class="sr-only">Responsibilities</h4>
          <ul role="list" class="p-4 space-y-2 text-sm leading-6 opacity-70">
            ...
            <li class="flex gap-x-3">
              ...
              Align and coordinate product development across multiple teams to ensure dependencies are dealt with
              inside as well as outside the project.
            </li>
            <li class="flex gap-x-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <li class="flex gap-x-3">
              ...
              Foster a collaborative, agile culture and define the associated prerequisites such as agile processes,
              communication channels and common tools for all teams.
            </li>
          </ul>
        </div>
      </section>
      <section class="items-start grid-cols-3 col-span-3 gap-8 mx-auto mb-8 md:grid">
        <div class="mb-4">
          <h3 class="items-center text-xl font-semibold">Art Director &amp; Lead Designer</h3>
          <div class="text-gray-500">August 2011 - May 2018</div>
          <p class="text-gray-500">arsmedium</p>
        </div>
        <div class="col-span-2">
          <h4 class="sr-only">Achievements</h4>
          <div class="p-4 space-y-2 text-sm font-medium bg-contrast">
            <p class="flex items-start gap-2">
              ...
              Constantly increasing customers performance (40% more turnover) in highly competitive loan industries.
            </p>
            <p class="flex items-start gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <ul role="list" class="p-4 space-y-2 text-sm leading-6 opacity-70">
            ...
            <li class="flex gap-x-3">
              ...
              Streamlined the UX and performance of websites, landing pages, and application routes for various
              financial products.
            </li>
          </ul>
        </div>
